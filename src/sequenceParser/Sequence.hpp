...
class Sequence
{
  public:
    ...
    Sequence(const std::string& prefix,
             const std::size_t padding,
             const size_t maxPadding,
...
#ifndef SWIG
    Sequence(const std::filesystem::path& directory, const Sequence& v) { operator=(v); }
  ...
  public:
    ...
    {
        return (_prefix == other._prefix) && (_suffix == other._suffix) && (_maxPadding == other._maxPadding) &&
               (_fixedPadding == other._fixedPadding) && (_ranges == other._ranges);
    }
