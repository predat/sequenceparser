...
class FrameRangesConstIterator
{
  public:
    ...
    inline self_type next() { return this->operator++(); }
    ...
    inline self_type previous() { return this->operator--(); }
    ...
    inline bool operator!=(const self_type& other) const { return !operator==(other); }
