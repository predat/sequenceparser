...
Sequence privateBuildSequence(const Sequence& defaultSeq,
...
void privateBuildSequencesAccordingToPadding(std::vector<Sequence>& result,
 ...
 */
std::vector<Sequence> buildSequences(const std::filesystem::path& directory,
                                     const detail::FileStrings& stringParts,
 ...
 */
std::size_t decomposeFilename(const std::string& filename,
                              detail::FileStrings& stringParts,
                              detail::FileNumbers& numberParts,
                              const EDetection& options);
